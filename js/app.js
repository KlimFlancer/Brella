(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-partners")) new core(".slider-partners__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
    ...
    da.init();
    const ctx = document.getElementById("graphic-price").getContext("2d");
    new Chart(ctx, {
        type: "bar",
        data: {
            labels: [ "Deductible", "Annual Max" ],
            datasets: [ {
                label: "",
                data: [ 1644, 4039 ],
